...
pub trait Logger: Clone + core::fmt::Debug {
    ...
    /// Adds a new region to the logger.
    fn update_delimiter<T: Into<Self::RegionDelimiter>, C: Composition>(&mut self, _region: T, _state: &mut GAState<C>) {}
...
impl Logger for NoLogger {
    ...
    fn record_backtrace(&mut self, _bt: Option<CallStack>) {}
}
